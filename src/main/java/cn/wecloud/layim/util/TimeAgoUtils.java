...
public class TimeAgoUtils {
	...
	public static String format(Date date) {
		...
		return format(DateUtil.format(date,s),s);
	}
	...
	public static String format(String createTime,String pattern) {
		LocalDateTime time = LocalDateTime.parse(createTime, DateTimeFormatter.ofPattern(pattern));
